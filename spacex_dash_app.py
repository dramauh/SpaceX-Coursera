...
spacex_df.columns
station_df = sorted(spacex_df['Launch Site'].unique())
print(spacex_df.groupby(['Launch Site']).mean())

max_payload = spacex_df['Payload Mass (kg)'].max()
min_payload = spacex_df['Payload Mass (kg)'].min()
#filtered_df = spacex_df[['Launch Site','class']]
#data=filtered_df.groupby('Launch Site').get_group('KSC LC-39A')   
...
# TASK 4:,Input(component_id='site-dropdown', component_property='value')
